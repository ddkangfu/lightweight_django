...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ('id', 'name', 'description', 'sprint', 'status_display', 'order', 'assigned', 'started',
                  'due', 'completed', 'links',)
    ...
    def validate(self, attrs):
        ...
        if completed and status != Task.STATUS_DONE:
            msg = _('Completed date coanot be set for uncompleted tasks.')
            raise serializers.ValidationError(msg)
        return attrs
